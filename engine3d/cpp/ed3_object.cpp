...
void d3Object::debug_DrawAABBox( const d3RenderData& renderData, const d3AABBox& b,  sRGBColor cl ) const
{
	...
	_debug_vb().AddVertex( bNew.GetCorner( 0 ) );
	_debug_vb().SetDiffiuseColor( cl );
	_debug_vb().AddVertex( bNew.GetCorner( 1 ) );
	_debug_vb().SetDiffiuseColor( cl );

	_debug_vb().AddVertex( bNew.GetCorner( 0 ) );
	_debug_vb().SetDiffiuseColor( cl );
	_debug_vb().AddVertex( bNew.GetCorner( 2 ) );
	_debug_vb().SetDiffiuseColor( cl );

	_debug_vb().AddVertex( bNew.GetCorner( 2 ) );
	_debug_vb().SetDiffiuseColor( cl );
	_debug_vb().AddVertex( bNew.GetCorner( 3 ) );
	_debug_vb().SetDiffiuseColor( cl );
	...
	_debug_vb().AddVertex( bNew.GetCorner( 0 ) );
	_debug_vb().SetDiffiuseColor( cl );
	_debug_vb().AddVertex( bNew.GetCorner( 4 ) );
	_debug_vb().SetDiffiuseColor( cl );

	_debug_vb().AddVertex( bNew.GetCorner( 2 ) );
	_debug_vb().SetDiffiuseColor( cl );
	_debug_vb().AddVertex( bNew.GetCorner( 6 ) );
	_debug_vb().SetDiffiuseColor( cl );

	_debug_vb().AddVertex( bNew.GetCorner( 3 ) );
	_debug_vb().SetDiffiuseColor( cl );
	_debug_vb().AddVertex( bNew.GetCorner( 7 ) );
	_debug_vb().SetDiffiuseColor( cl );

	_debug_vb().AddVertex( bNew.GetCorner( 1 ) );
	_debug_vb().SetDiffiuseColor( cl );
	_debug_vb().AddVertex( bNew.GetCorner( 5 ) );
	_debug_vb().SetDiffiuseColor( cl );
